package com.example.SkyNest.service.SuperAdminService;
...
public class SuperAdminServ {
    ...
    // todo : super admin profile by token
    public UserInfo profile() {
        ...
        return userOptional.map(SuperAdminServ::getProfileInfo).orElse(null);
    }
